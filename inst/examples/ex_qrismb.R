...
fit1 <- qrismb(fm, data = lung2, t0 = 400, Q = 0.5, ne = 200, "rq", "smooth")
fit2 <- qrismb(fm, data = lung2, t0 = 500, Q = 0.5, ne = 200, "one", "nonsmooth")
fit3 <- qrismb(fm, data = lung2, t0 = 600, Q = 0.5, ne = 200, "random", "iterative")
